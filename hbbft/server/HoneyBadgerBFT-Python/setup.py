...
setup(
    ...
    packages=['honeybadgerbft', 'honeybadgerbft.core', 'honeybadgerbft.crypto', 'honeybadgerbft.crypto.ecdsa',
              'honeybadgerbft.crypto.threshenc', 'honeybadgerbft.crypto.threshsig'],
