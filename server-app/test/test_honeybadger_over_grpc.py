...
try:
    sys.path.append(os.path.join(project_dir, "common", "grpc_tool"))
    sys.path.append(os.path.join(project_dir, "common", "grpc_tool", "generated"))
...
try:
    # Import the honeybadgerbft lib source files
    sys.path.append(os.path.join(parent_dir, "lib", "HoneyBadgerBFT-Python"))
